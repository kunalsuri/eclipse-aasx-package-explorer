...
# eclipse-aasx-package-explorer — Claude Code project memory
...
- **Frozen upstream.** Code inherited from **eclipse-aaspe/package-explorer** is off-limits unless the task explicitly requires it. New work goes in our own modules.
