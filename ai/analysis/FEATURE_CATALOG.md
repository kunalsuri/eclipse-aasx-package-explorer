...
# Feature Catalog — eclipse-aasx-package-explorer Master Index
...
Depending on the complexity of eclipse-aasx-package-explorer, the catalog can live in a single file or be split to reduce token context overhead:
